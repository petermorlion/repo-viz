...
},{"./user-api/branch-user-api":15}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class BranchesOrder {
...
},{"./branch":2,"./branches-paths":4,"./commit":6,"./gitgraph":7,"./orientation":11,"./refs":12,"./tag":13,"./template":14,"./user-api/branch-user-api":15,"./user-api/gitgraph-user-api":16,"./utils":17}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Commit {
    ...
    setTags(tags, getTagStyle) {
        this.tags = tags
            .getNames(this.hash)
            .map((name) => new tag_1.Tag(name, getTagStyle(name), this.style));
        return this;
    }
...
},{"./tag":13}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class GitgraphCore {
    ...
    computeRenderedCommits() {
        ...
        return (commitsWithBranches
            ...
            .map((commit) => commit.setTags(this.tags, (name) => Object.assign({}, this.tagStyles[name], this.template.tag))));
    }
    /**
...
},{"./branch":2,"./branches-order":3,"./branches-paths":4,"./graph-rows":9,"./orientation":11,"./refs":12,"./template":14,"./user-api/gitgraph-user-api":16,"./utils":17}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./regular":10}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Tag {
    ...
    constructor(name, tagStyle, commitStyle) {
        this.name = name;
...
class BranchUserApi {
    ...
    _getCommitStyle(style = {}) {
        ...
        return Object.assign({}, utils_1.withoutUndefinedKeys(this._graph.template.commit), utils_1.withoutUndefinedKeys(this._branch.commitDefaultOptions.style), style, { message, dot: Object.assign({}, utils_1.withoutUndefinedKeys(this._graph.template.commit.dot), utils_1.withoutUndefinedKeys(this._branch.commitDefaultOptions.style.dot), style.dot) });
    }
}
...
},{"../commit":6,"../gitgraph":7,"../utils":17}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const commit_1 = require("../commit");
const branch_1 = require("../branch");
...
},{"../branch":2,"../commit":6,"../refs":12}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const orientation_1 = require("./orientation");
/**
...
},{"./orientation":11}],18:[function(require,module,exports){
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@gitgraph/core')) :
	typeof define === 'function' && define.amd ? define(['exports', '@gitgraph/core'], factory) :
	(factory((global.gitgraph = global.gitgraph || {}, global.gitgraph.core = {}),global.gitgraph.core));
...
function createGitgraph(graphContainer, options) {
    ...
    var gitgraph = new core.GitgraphCore(options);
    ...
    function adaptSvgOnUpdate() {
        ...
        function computeOffsets() {
            ...
            var orientedCommits = gitgraph.orientation === core.Orientation.VerticalReverse
                ? commits
                : commits.reverse();
    ...
    function renderBranchesPaths(branchesPaths) {
        ...
        var isBezier = gitgraph.template.branch.mergeStyle === core.MergeStyle.Bezier;
        var paths = Array.from(branchesPaths).map(function (_a) {
            var branch = _a[0], coordinates = _a[1];
            return createPath({
                d: core.toSvgPath(coordinates.map(function (coordinate) { return coordinate.map(getWithCommitOffset); }), isBezier, gitgraph.isVertical),
                fill: "transparent",
    ...
    function renderCommits(commits) {
        ...
        function renderArrows(commit) {
            ...
            return commit.parents.map(function (parentHash) {
                ...
                var path = createPath({
                    d: core.arrowSvgPath(gitgraph, parent, commit),
    ...
    function appendTooltipToGraph(commit) {
        if (!svg.firstChild)
            return;
        if (gitgraph.isVertical && gitgraph.mode !== core.Mode.Compact)
            return;
